...
| **Sprint 1 Retrospective Summary**    | EEl equipo destacó avances en comunicación y colaboración, la integración exitosa entre frontend y backend, y la mejora en los artefactos previos. Se identificó la importancia de definir criterios de aceptación claros y afinar estimaciones para próximos sprints.                    |
| **Sprint Goal & User Stories**        | CConstruir el núcleo visible y funcional de TripMatch: landing, backend básico, evidenciar UX y validar los principales requerimientos funcionales en la aplicación.                                                 |
...
|:-------------:|:------------------------------------------------------------------------------------------------------------------------:|:-----------------:|:-----------------------------------------:|:------------------------------------------------------------------------:|:----------:|:---------------:|:----------:|
| US01          | Registro de nuevo usuario con validación | T01               | Formulario de registro y onboarding       | Implementar formulario de registro, validación de datos y bienvenida     | 8h         | Equipo Frontend  | Done       |
| US02          |         Inicio de sesión con credenciales y manejo de errores        | T01               | Interfaz y lógica de login                | Crear pantalla de login y lógica de autenticación                        | 6h         | Equipo Frontend  | Done       |
| US03          |  Garantía de seguridad y confirmación de la contraseña      | T01               | Validación de contraseña                  | Validar seguridad y confirmación de contraseña                            | 4h         | Equipo Frontend  | Done       |
| US04          |  Recomendaciones basadas en Popularidad y Categorías en la Home  | T04               |     Desarrollar recomendaciones personalizadas     |  Desarrollar la lógica para mostrar recomendaciones basadas en popularidad y preferencias del usuario.  |    6h      | Equipo Frontend  | Done       |
| US05          | Acciones rápidas en la tarjeta de experiencia (Favoritos y Navegación)                           | T05               | Favoritos y navegación rápida  |    Implementar la funcionalidad para marcar experiencias como favoritas y navegar rápidamente entre ellas.   |     6h     | Equipo Frontend  | Done       |
| US06          | Búsqueda inicial, mapa centrado y refinamiento dinámico de filtros  | T06               | Búsqueda y filtros dinámicos  |        Desarrollar la lógica para realizar una búsqueda de experiencias y filtros dinámicos (destino, tipo, presupuesto).  |   7h     | Equipo Frontend   | Done       |
| US07          | Visualización de resultados con carga incremental  | T07               | Carga progresiva de resultados  |        Implementar carga incremental de resultados (scroll infinito o "Ver más").  |   6h     | Equipo Frontend   | Done       |
| US08          | Visualizar mis reservas en un calendario móvil  | T08               | Calendario de reservas  |        Crear visualización de reservas en formato calendario.  |   7h     | Equipo Frontend   | To-do       |
| US09          | Visualizar mis reservas en formato lista  | T09               | Vista lista de reservas  |        Crear vista en lista de reservas con detalles claros.  |   6h     | Equipo Frontend   | Done       |
| US10          | Buscar experiencias dentro de mi itinerario  | T10               | Buscador en itinerario  |       Crear buscador dentro de "Mi itinerario" para localizar experiencias específicas.  |   5h     | Equipo Frontend   | Done       |
| US11          | Cancelar una reserva desde el itinerario  | T11               | Cancelación de reserva  |  Permitir la cancelación de reservas directamente desde "Mi itinerario".  |   6h     | Equipo Frontend   | Done       |
| US12          | Visualizar reservas confirmadas en formato lista  | T12               | Lista de reservas confirmadas  |  Crear vista de reservas confirmadas para empresas turísticas.  |   6h     | Equipo Frontend   | Done       |
| US13          | Acceder a la creación de experiencias desde Gestión de Experiencias  | T13               | Botón para agregar experiencia  |  Crear un botón "Agregar experiencia" en la sección de gestión.  |   5h     | Equipo Frontend   | Done       |
| US14          | Registrar detalles de una experiencia en el formulario  | T14               | Formulario para registrar experiencia  |  Crear formulario para agregar detalles (nombre, descripción, etc.) de una experiencia.  |   8h     | Equipo Frontend   | Done       |
| US15          | Editar experiencias existentes  | T15               | Implementación de edición de experiencias  |  Crear funcionalidad para editar experiencias existentes.  |   7h     | Equipo Frontend   | Done       |
| US16          | Eliminar experiencias publicadas  | T16               | Eliminación de experiencias  |  Crear funcionalidad para eliminar experiencias publicadas.  |   6h     | Equipo Frontend   | Done       |
| US17          | Visualizar listado de experiencias creadas  | T17               | Listado de experiencias  |  Crear una vista que muestre todas las experiencias publicadas por la agencia.  |   6h     | Equipo Frontend   | Done       |
| US18          | Buscar experiencias por nombre o categoría  | T18               | Búsqueda por nombre o categoría  |  Crear funcionalidad para filtrar experiencias por nombre o categoría.  |   5h     | Equipo Frontend   | Done       |
| US19          | Realizar una reserva desde la vista de detalle de experiencia  | T19               | Reserva desde detalles de experiencia  |  Crear funcionalidad para realizar reservas desde la vista de detalle.  |   7h     | Equipo Frontend   | Done       |
| US20          | Recibir notificación de confirmación de reserva  | T20               | Notificación de reserva confirmada  |  Enviar notificación al confirmar una reserva  |   6h     | Equipo Frontend   | Done       |
| US21          | Recibir notificación de confirmación de reserva  | T21               | Notificación de reserva confirmada  |  Enviar notificación al confirmar una reserva  |   6h     | Equipo Frontend   | Done  |
| US22          | Enviar consulta desde los detalles de una experiencia  | T22               | Consulta desde detalles de experiencia  |  Crear funcionalidad para enviar una consulta directamente desde la vista de detalle de la experiencia.  |   6h     | Equipo Frontend   | Done  |
| US23          | Visualizar consultas recibidas de turistas  | T23               | Implementación de visualización de consultas |  Crear vista para que las agencias visualicen las consultas de los turistas.  |   6h     | Equipo Frontend   | Done  |
| US24          | Responder consultas de turistas | T24               | Implementación de responder consultas |  Crear funcionalidad para que las agencias respondan a las consultas de turistas.  |   6h     | Equipo Frontend   | Done  |
| US25          | Recibir notificación de respuesta a consulta | T25               | Notificación a turista |  Enviar notificación  al turista cuando la agencia responda a su consulta.  |   5h     | Equipo Frontend   | Done  |
| US26          | Consultar historial de mis preguntas y respuestas | T26               | Historial de consultas |  Crear sección para que los turistas consulten el historial de preguntas y respuestas.  |   5h     | Equipo Frontend   | Done  |
| US27          | Dejar una reseña con calificación en estrellas y comentario | T27               | Implementación de dejar reseña |  Permitir a los turistas dejar reseñas con calificación en estrellas y comentarios.  |   6h     | Equipo Frontend   | Done  |
| US28          | Editar o eliminar mi reseña publicada | T28               | Implementación de editar/eliminar reseña |  Permitir a los turistas editar o eliminar sus reseñas publicadas.  |   5h     | Equipo Frontend   | Done  |
| US29          | Visualizar reseñas de otros turistas en la agencia | T29               | Implementación de visualización de reseñas |  Crear vista para que los turistas vean las reseñas de otros turistas.  |   6h     | Equipo Frontend   | Done  |
| US30          | Visualizar reseñas y promedio de calificaciones en mi perfil | T30               | Reseñas en el perfil |  Crear sección en el perfil de la agencia para mostrar reseñas y promedio de calificaciones.  |   6h     | Equipo Frontend   | Done  |
| US31          | Editar información personal en el perfil | T31               | Editar perfil personal |  Crear funcionalidad para que los turistas editen su información personal.  |   5h     | Equipo Frontend   | Done  |
| US32          | Visualizar mi perfil con datos actualizados | T32               | Implementación de visualización del perfil actualizado |  Mostrar la información actualizada del perfil del turista.  |   4h     | Equipo Frontend   | Done  |
| US33          | Editar información del perfil de agencia | T33               | Implementación de edición del perfil de agencia |  Permitir a las agencias editar su perfil (datos de contacto, descripción).  |   6h     | Equipo Frontend   | Done  |
| US34          | Ver reseñas en el perfil de agencia | T34               | Visualización de reseñas en perfil de agencia |  Permitir a las agencias ver las reseñas que los turistas dejan en su perfil.  |   5h     | Equipo Frontend   | Done  |
| US35          | Mostrar estadísticas en el perfil de agencia | T35       | Estadísticas en perfil de agencia  |  Mostrar estadísticas (promedio de calificaciones, número de reseñas, reservas) en el perfil de la agencia.  |   6h     | Equipo Frontend   | Done  |
| US36          | Descubrimiento de beneficios para turistas | T36       | Implementación de sección de beneficios  |  Crear sección en la landing page que muestre los beneficios para los turistas.  |   4h     | Equipo Frontend   | Done  |
| US37          | Conocer el propósito de la plataforma | T37       | Implementación de sección “About Us”  |  Crear sección de la landing page con la misión y propósito de la plataforma.  |   4h     | Equipo Frontend   | Done  |
| US38          | Navegación simple desde el header | T38       | Implementación de navegación fluida  |  Crear navegación fácil y fluida en el menú superior de la landing page  |   3h     | Equipo Frontend   | Done  |
| US39          | Acceder al formulario de contacto | T39       | Formulario de contacto  |  Crear acceso fácil al formulario de contacto en la landing page.  |   3h     | Equipo Frontend   | Done  |
| US40          | Registro desde la landing | T40       | Implementación de botón de registro  |  Crear botón de registro en la landing page para facilitar el acceso a la inscripción.  |   4h     | Equipo Frontend   | Done  |
| US41          | Identificación de beneficios para agencias | T41       | Implementación de beneficios para agencias  |  Crear sección de beneficios de la plataforma para agencias en la landing page.  |   5h     | Equipo Frontend   | Done  |
| US42          | Conocer cómo funciona la plataforma | T42       | Sección de explicación  |  Crear sección de explicación de funcionamiento de la plataforma para agencias en la landing page  |   4h     | Equipo Frontend   | Done  |
